        ...
        <div class="row">
            <div class="col-md-12 align-items-center">
                <div class="text-center">
                    ...
                    <h3 class="text-uppercase">LAPORAN PENGIRIMAN INFORMASI JADWAL SIDANG JURUSITA MELALUI WHATSAPP<br>PADA PENGADILAN AGAMA <span class="text-uppercase"><?php echo $nama_pa; ?></span><br>BULAN <?php echo $bulan; ?> TAHUN <?php echo $tahun; ?></h3>
                </div>
                        ...
                        <tbody>
                            <?php
                             ...
                             <tr>
                                 ...
                                 <td><?php echo ($val->ecourt==0)?'Tidak':'Ya'; ?></td>
                                 <td class="tgl"><?php echo tgl_aja($val->tanggal_sidang); ?></td>
                                 <td><?php echo $val->jurusita_nama; ?></td>
                                 <td><?php echo $val->nomorhp; ?></td>
