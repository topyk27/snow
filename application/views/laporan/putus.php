...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Cetak Laporan Putusan</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <table id="dt_laporan_putus" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>#</th>
	...
	<script src="<?php echo base_url('asset/mine/js/laporan/putus.min.js') ?>"></script>
</body>
</html>