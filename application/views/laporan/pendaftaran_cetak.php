		...
		<div class="row">
			<div class="col-md-12 align-items-center">
				<div class="text-center">
					...
					<h3 class="text-uppercase">LAPORAN PENGIRIMAN INFORMASI PENDAFTARAN MELALUI WHATSAPP<br>PADA PENGADILAN AGAMA <span class="text-uppercase"><?php echo $nama_pa; ?></span><br>BULAN <?php echo $bulan; ?> TAHUN <?php echo $tahun; ?></h3>
				</div>
